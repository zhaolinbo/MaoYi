	...
	<div style="width: 970px; height: 1350px; margin: 0 auto;">
		...
		<div style="width: 970px;height: 580px;">
			...
			<div
				...
				<p style="font-family: Microsoft YaHei;font-size:15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">联系人：金总经理 13906461121</p>
				<p style="font-family: Microsoft YaHei;font-size: 15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">业务联系人：崔经理 13738447771</p>
				<p style="font-family: Microsoft YaHei;font-size: 15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">电话：86-0536-7958115</p>
				<p style="font-family: Microsoft YaHei;font-size: 15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">传真：86-0536-7958115</p>
				...
				<p style="font-family: Microsoft YaHei;font-size: 15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">网址：www.yihezhu.com</p>
				<p style="font-family: Microsoft YaHei;font-size: 15px;color:#5CACEE;margin-left: 25px;margin-right: 25px;line-height: 30px;">地址：山东省潍坊市奎文区胜利东街5111号&nbsp;潍坊金融服务区1号楼1-911</p>
				<!-- 下面是地图 -->
				</div>
		</div>
