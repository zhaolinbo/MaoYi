...
<body>
	...
	<div style="width: 970px; height: 1460px; margin: 0 auto;">
		...
		<div style="width: 970px;height:700px;">
			<div style="float: left;">
				<div class="CPFLdiv">
			...
			<div
				style="float: left; width:720px;height: 600px;background-color: white; ">
				<p style="font-family: Microsoft YaHei;font-size: 8px;margin-left: 470px;">您现在的位置：<a href="index.jsp">首页</a> ><a href="protuct.jsp">产品中心</a>><a href="Productionprocess.jsp">产品生产工艺</a></p>
