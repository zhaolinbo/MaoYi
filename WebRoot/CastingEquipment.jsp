...
<body>
	<!-- 最大的div -->
	<div style="width: 970px; height: 1370px; margin: 0 auto;">
		<!-- 存放logo -->
		<div class="logo">
		...
		<div style="width: 970px;height: 600px;">
			...
			<div
				...
				<p style="font-family: Microsoft YaHei;font-size: 8px;margin-left: 470px;">您现在的位置：<a href="index.jsp">首页</a> ><a href="protuct.jsp">产品中心</a>><a href="CastingEquipment.jsp">设备床身铸件</a></p>
