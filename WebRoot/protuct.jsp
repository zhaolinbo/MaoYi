...
<body>
	...
	<div style="width: 970px; height: 1260px; margin: 0 auto;">
		...
		<div style="width: 970px;height: 800px;">
			...
			<div
				style="float: left; width:720px;height: 750px;background-color: white; ">
				<p style="font-family: Microsoft YaHei;font-size: 8px;margin-left: 545px;">您现在的位置：<a href="index.jsp">首页</a> >产品中心</p>
