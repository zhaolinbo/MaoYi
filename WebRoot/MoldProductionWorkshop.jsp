...
<body>
	...
	<div style="width: 970px; height: 1350px; margin: 0 auto;">
		...
		<div style="width: 970px;height: 600px;">
			...
			<div
				style="float: left; width:720px;height: 580px;background-color: red; ">
				<p style="font-family: Microsoft YaHei;font-size: 8px;margin-left: 470px;">您现在的位置：<a href="index.jsp">首页</a> ><a href="protuct.jsp">产品中心</a>><a href="MoldProductionWorkshop.jsp">模具生产车间</a></p>
